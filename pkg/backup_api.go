...
/*
BackupApiService Create manual backup
Create a manual instance backup
* @param ctx context.Context for authentication, logging, tracing, etc.
@param data
@return ResponseTask
*/
func (a *BackupApiService) CreateBackup(ctx context.Context, data RequestBackupCreate) (ResponseTask, *http.Response, error) {
	var (
...
/*
BackupApiService Delete backup
Delete backup
* @param ctx context.Context for authentication, logging, tracing, etc.
@param id Backup ID
@return ResponseTask
*/
func (a *BackupApiService) DeleteBackup(ctx context.Context, id string) (ResponseTask, *http.Response, error) {
	var (
