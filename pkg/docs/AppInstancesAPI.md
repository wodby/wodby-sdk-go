...
[**PauseAppInstance**](AppInstancesAPI.md#PauseAppInstance) | **Post** /app-instances/{id}/actions/pause | Pause app instance
[**ResumeAppInstance**](AppInstancesAPI.md#ResumeAppInstance) | **Post** /app-instances/{id}/actions/resume | Resume app instance
...
> OperationResult PauseAppInstance(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AppInstancesAPI.PauseAppInstance(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AppInstancesAPI.PauseAppInstance``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PauseAppInstance`: OperationResult
	fmt.Fprintf(os.Stdout, "Response from `AppInstancesAPI.PauseAppInstance`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPauseAppInstanceRequest struct via the builder pattern
...
> OperationResult ResumeAppInstance(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AppInstancesAPI.ResumeAppInstance(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AppInstancesAPI.ResumeAppInstance``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ResumeAppInstance`: OperationResult
	fmt.Fprintf(os.Stdout, "Response from `AppInstancesAPI.ResumeAppInstance`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiResumeAppInstanceRequest struct via the builder pattern
