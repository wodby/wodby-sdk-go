...
------------ | ------------- | ------------- | -------------
**AppServiceIds** | Pointer to **[]int32** | App services to protect. Omit every scope field to preserve the current scope, or pass an empty list to protect the whole app environment. | [optional] 
