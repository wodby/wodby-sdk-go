...
//  @return CurrentUser
func (a *UserAPIService) GetCurrentUserExecute(r ApiGetCurrentUserRequest) (*CurrentUser, *http.Response, error) {
	var (
...
func (r ApiUpdateCurrentUserRequest) Execute() (*CurrentUser, *http.Response, error) {
...
// Execute executes the request
//  @return CurrentUser
func (a *UserAPIService) UpdateCurrentUserExecute(r ApiUpdateCurrentUserRequest) (*CurrentUser, *http.Response, error) {
	var (
