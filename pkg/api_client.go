...
// APIClient manages communication with the Wodby API Reference API v3.x
...
type APIClient struct {
	...
	GitRepositoryApi	*GitRepositoryApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.GitRepositoryApi = (*GitRepositoryApiService)(&c.common)
