...
// checks if the BackupsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupsResponse{}

// BackupsResponse struct for BackupsResponse
...
type _BackupsResponse BackupsResponse
...
func (o *BackupsResponse) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o BackupsResponse) MarshalJSON() ([]byte, error) {
...
func (o BackupsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BackupsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBackupsResponse := _BackupsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackupsResponse)

	if err != nil {
		return err
	}

	*o = BackupsResponse(varBackupsResponse)

	return err
}

type NullableBackupsResponse struct {
	value *BackupsResponse
	isSet bool
}

func (v NullableBackupsResponse) Get() *BackupsResponse {
	return v.value
}

func (v *NullableBackupsResponse) Set(val *BackupsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBackupsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBackupsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackupsResponse(val *BackupsResponse) *NullableBackupsResponse {
	return &NullableBackupsResponse{value: val, isSet: true}
}

func (v NullableBackupsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackupsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
